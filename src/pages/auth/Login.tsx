  ...
  return (
    <div data-testid="login-page" className="w-full md:max-w-[95%] mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full pt-3 flex flex-col gap-5">
        <div>
          <label className="mb-2 block text-[12px] font-semibold uppercase tracking-[0.14em] text-white/85">
            Email
          </label>
          <input
            type="email"
        ...
        <div>
          <div className="mb-2 flex items-center justify-between">
            <label className="block text-[12px] font-semibold uppercase tracking-[0.14em] text-white/85">
              Password
            </label>
      ...
      <div className="flex items-center justify-center gap-[13px] text-sm font-semibold leading-4 text-[#FCFCFC] max-sm:flex-col">
        <button
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 bg-[#0f1020]/80 py-3.5 text-[#FCFCFC] shadow-[0_8px_24px_rgba(8,10,30,0.4)] transition-all hover:bg-black/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-200/70"
