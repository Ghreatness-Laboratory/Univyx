              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <div className="text-secondary text-sm">
                    <p>Contact the university for specific admission requirements.</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {selectedCollege?.courses && selectedCollege.courses.length > coursesPerPage && (
                    <Pagination
        ...
        <div className="p-4 md:p-6 border-t">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {university.ambassadors?.length ? (
              university.ambassadors.map((ambassador) => (
                ...
                >
                  <div className="h-48 overflow-hidden">
                    <img
                      src={ambassador.photo || '/placeholder-avatar.jpg'}
                      alt={ambassador.name}
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-secondary mb-2">{ambassador.position}</p>
                    <p>
                      Email:{" "}
                    ...
                    {ambassador.phone && (
                      <p>
                        Phone:{" "}
                        <span className="text-secondary">{ambassador.phone}</span>
                      </p>
                    )}
                  </div>
                </motion.div>
              ...
              <p className="text-secondary col-span-3 text-center py-8">
                No ambassadors available for this university.
              </p>
            )}
          </div>
        </div>
